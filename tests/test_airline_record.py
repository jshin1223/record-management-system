...
from record.airline import AirlineRecord  # Adjust this import to match the correct file location
from conf.config import AIRLINE_FILE  # Adjust this import to match the correct file location
