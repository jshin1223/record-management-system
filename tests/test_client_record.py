...
from record.client import ClientRecord  # Adjust based on where your ClientRecord class is located
from conf.config import CLIENT_FILE  # Adjust the import based on the actual file path
