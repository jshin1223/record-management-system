...
from src.record.airline import AirlineRecord  # Importing backend logic for managing airline records
...
def manage_airline_gui():
    ...
    window = tk.Toplevel()
    root = tk.Toplevel()
    tk.Entry(root, name="airline_id_entry").pack()
    tk.Entry(root, name="company_name_entry").pack()
    ...
    airline_id_entry = tk.Entry(window, name = "airline_id_entry")
    ...
    company_name_entry = tk.Entry(window, name="company_name_entry")
    ...
    tk.Button(button_frame, text="Save", command=save_airline, name="save_button").pack(side="left", padx=5)
    tk.Button(button_frame, text="Search", command=search_airline, name="search_button").pack(side="left", padx=5)
    tk.Button(button_frame, text="Update", command=update_airline, name="update_button").pack(side="left", padx=5)
    tk.Button(button_frame, text="Delete", command=delete_airline, name="delete_button").pack(side="left", padx=5)
