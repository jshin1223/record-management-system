...
def manage_client_gui():
    ...
    name_entry = tk.Entry(window, name="name_entry")  # Entry field for Name
    ...
    address1_entry = tk.Entry(window, name="address1_entry")  # Entry field for Address Line 1
    ...
    address2_entry = tk.Entry(window, name="address2_entry")  # Entry field for Address Line 2
    ...
    address3_entry = tk.Entry(window, name="address3_entry")  # Entry field for Address Line 3
    ...
    city_entry = tk.Entry(window, name="city_entry")  # Entry field for City
    ...
    state_entry = tk.Entry(window, name="state_entry")  # Entry field for State
    ...
    zip_entry = tk.Entry(window, name="zip_entry")  # Entry field for Zip Code
    ...
    country_entry = tk.Entry(window, name="country_entry")  # Entry field for Country
    ...
    phone_entry = tk.Entry(window, name="phone_entry")  # Entry field for Phone Number
    ...
    result_text = tk.Text(window, height=8, width=50, name="result_text")  # Multi-line textbox for displaying search results
  ...
  # Delete client
    ...
    search_entry = tk.Entry(window, justify="center", name="search_entry")  # Entry field for search input
    ...
    button_frame.grid(row=14, column=0, columnspan=3, pady=10)  # Place the frame in the grid

    tk.Button(button_frame, text="Save", name="save_button", command=save_client).grid(row=0, column=0, padx=10, pady=10)
    tk.Button(button_frame, text="Search", name="search_button", command=search_client).grid(row=0, column=1, padx=10, pady=10)
    tk.Button(button_frame, text="Update", name="update_button", command=update_client).grid(row=0, column=2, padx=10, pady=10)
    tk.Button(button_frame, text="Delete", name="delete_button", command=delete_client).grid(row=0, column=3, padx=10, pady=10)
